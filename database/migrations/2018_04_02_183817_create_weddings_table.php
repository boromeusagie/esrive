...
class CreateWeddingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('weddings', function (Blueprint $table) {
            ...
            $table->string('wedding_rec')->default('Akad Nikah');
            $table->date('wedding_rec_date')->nullable();
