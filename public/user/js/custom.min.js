$(function() {
    ...
    var set = function() {
        ...
        $(".navbar-brand span").hide(), $(".sidebartoggler i").toggleClass("ti-menu")) : ($("body").removeClass("mini-sidebar"),
    ...
    $(window).ready(set), $(window).on("resize", set), $(".sidebartoggler").on("click", function() {
        ...
        $("body").toggleClass("show-sidebar"), $(".nav-toggler i").toggleClass("ti-angle-left"),
